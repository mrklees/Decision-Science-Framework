...
class DistFinder(object):
    ...
    def optimize(self, starting_values=None):
        """ Method for running the hill climbing optimization of our parameters
        
        Starting values here are helpful in getting the shape you want for the beta
        distribution since it's so flexible. 
        """
